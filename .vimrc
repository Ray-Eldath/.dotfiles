"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Ray Eldath .vimrc: based on amix-vimrc with many plugins installed.
" You should install vim-plug first.
"
" Maintainer:
...
" => VIM user interface
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Set how many lines to the cursor - when moving vertically using j/k
set so=3
